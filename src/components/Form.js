...
const Form = (props) => {
  ...
  return (
	<React.Fragment>
		<input id="title" type="text" placeholder="name" className="form-control form-control-lg mb-2" />
		<input id="amount" type="number" placeholder="amount" className="form-control form-control-lg mb-2" />
